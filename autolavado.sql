...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2022 a las 21:11:29
...
(1, 'Antonio', 'Martinez', 'Perez', 'C. Benito Juarez #24 Col. Los Alpes Necaxa Juan Galindo ', '764596326', 'PApaski@outlook.com', '2022-03-27', 1, NULL, NULL),
(2, 'Ulises ', 'Perez', 'Paredes', 'C. Almedo #36 Col. Las Piedras Alamo Veracruz', '555622381', 'jahsgd@gmail.com', '2022-03-02', 1, NULL, NULL);
...
(1, 'Lavado y Encerado completo.', 500, 1, '2022-03-10', NULL, NULL);
...
(1, 'Francisco', 'Toledo', 'Jimenez', 'C. Anillo. #2 Col. Lomas Prieto. Chihuahua ', '6589643257', 'limonpap@outlook.com', 'Lavador', 1, 'CacaAsada123', NULL, NULL),
(2, 'Marco', 'Lopez', 'Urieta', 'C. Maiz # 14 Col. Quemas. Jalisco', '5682652561', 'Marco10@gmail.com', 'Cajero', 1, 'cACAaSADA123', NULL, NULL);
...
(1, 'Jose Kael Santos Lopez', 'KAELO_RUIZ@outlook.com', '2022-03-23 20:06:06', 'Pepas2703', '27032000', NULL, NULL);
...
(1, 'ef-37-238', 'Camioneta', 'Chevrolet', 2000, 'Azul', 2, 1, 1, '2022-03-30', NULL, NULL);
...
(1, '2022-03-30', 1, 1, 1, 1, '2022-03-30 20:08:43', '2022-03-30 20:25:36');
...
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `vehiculos`
  MODIFY `id_vehiculo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
